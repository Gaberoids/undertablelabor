...
class MessageToServiceForm(forms.ModelForm):
    print("inside form---------***********-----------------**************------------")
    m_body = forms.CharField(label='Body: ', help_text='4,000 maximun characters', widget=forms.Textarea(attrs={'placeholder': 'irriii!'}))
    class Meta:
    ...
    def __init__(self, *args, **kwargs):
        ...
        placeholders = {
            ...
            'm_body': "Enter here a message with 4,000 characters maximun",
